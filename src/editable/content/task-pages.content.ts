...
export const taskPageVoices = {
  ...
  sbm: {
    ...
    headline: 'Resources arranged like curated collections.',
  ...
  profile: {
    ...
    headline: 'Identity details are available by direct link.',
    description: 'Identity details are intentionally kept out of public discovery.',
    filterLabel: 'Filter member category',
    secondaryNote: 'Identity and credibility are presented directly and quietly.',
